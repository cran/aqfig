...
#    plt.beyond.zlim=TRUE, allow plotting of points which have z values outside
#    the bounds given by zlim.  For z values exceeding zlim[2], use the color
#    corresponding to zlim[2]; for z values below zlim[1], use the color for
#    zlim[1].  Also, added explicit parameters xlab and ylab.  This makes it
#    easier to test whether the user has provided xlab and ylab, and, if not,
#    allows these labels to default to the expressions the user named as
#    parameters x and y.  This is similar to the default behavior for image().
#
